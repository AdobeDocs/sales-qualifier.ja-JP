...
[!DNL Sales Qualifier]はスタンドアロン アプリケーションとして利用できるようになりました。 当初はAdobe Journey Optimizer B2Bの一部としてリリースされました。
...
* 自社のプレイブック資料でAIのアウトリーチを支援するためのナレッジセンター。 [詳細情報](knowledge-center.md)。
