...
**[!UICONTROL 電子メール送信]**&#x200B;を使用して、送信ワークフローと返信によって送信された電子メールを確認します。 何が送信されたかを確認し、コンテキストで返信を読み取り、メッセージを送信したアウトバウンドワークフローを開くことができます。
...
>[!NOTE]
>
>電子メールの送信トレイは読み取り専用です。 返信した見込み客をフォローアップするには、アウトバウンドワークフローまたは見込み客を開きます。 電子メールと返信のパフォーマンスを確認するには、[送信パフォーマンス &#x200B;](performance.md)を参照してください。
