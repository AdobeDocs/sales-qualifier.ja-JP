---
title: ナレッジセンタープレイブックの作成
description: Sales Qualifierナレッジセンターで、営業資料のアップロード方法やプレイブックの作成方法を学び、AIに関するアウトリーチと支援に活用できます。
...
1. **[!UICONTROL 統合]**&#x200B;の下の&#x200B;**[!UICONTROL ナレッジセンター]**&#x200B;を選択します。
...
ドキュメントをアップロードしたら、**[!UICONTROL プレイブックを作成]**&#x200B;を選択します。
